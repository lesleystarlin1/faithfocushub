...
<nav>
    ...
    <main>
        ...
        <section class="recommendations">
            ...
            <ul>
                <li><a href="#">The Purpose Driven Life by Rick Warren</a></li>
                <li><a href="#">Mere Christianity by C.S. Lewis</a></li>
                <li><a href="#">The Cross of Christ by John Stott</a></li>
                <li><a href="#">The Screwtape Letters by C.S. Lewis</a></li>
            </ul>
        </section>
        ...
        <section class="recommendations">
            ...
            <ul>
                <li><a href="#">The Bible Project</a></li>
                <li><a href="#">Theology in the Raw</a></li>
                <li><a href="#">The Gospel Coalition Podcast</a></li>
                <li><a href="#">Unbelievable?</a></li>
            </ul>
        </section>
        ...
        <section class="recommendations">
            ...
            <ul>
                <li><a href="#">BibleProject</a></li>
                <li><a href="#">The Ten Minute Bible Hour</a></li>
                <li><a href="#">Inspiring Philosophy</a></li>
                <li><a href="#">Ravi Zacharias International Ministries (RZIM)</a></li>
            </ul>
        </section>

        <section class="recommendations">
            <h2>Recommended Sermons</h2>
            <ul>
                <li><a href="#">"Sinners in the Hands of an Angry God" by Jonathan Edwards</a></li>
                <li><a href="#">"The Weight of Glory" by C.S. Lewis</a></li>
                <li><a href="#">"The Supremacy of Christ in a Postmodern World" by John Piper</a></li>
                <li><a href="#">"The Centrality of the Gospel" by Timothy Keller</a></li>
            </ul>
        </section>
    </main>
