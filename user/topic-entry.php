...
<head>
  ...
  <title>Topical Method Entry - FaithFocusHub</title>
    ...
    <section id="banner">
      <div class="study-container">
        ...
        <div class="single-study">
          <h2>Topical Method</h2>
          <form action="../php/save-topic.php" method="post">
          ...
          <p><a href="../php/view-soap2.php">View Your Topical Entries</a></p>
        </div>
      </div>
    </section>
  </main>
